...
function validateNewInstructor(incoming) {
    return __awaiter(this, void 0, void 0, function () {
        var assignment, createdAssignment, savedAssignment, mintedAssignment;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, instructor_1.assignmentRepository.create(assignment)];
                case 1:
                    createdAssignment = _a.sent();
                    return [4 /*yield*/, instructor_1.manager.save(createdAssignment)];
                case 2:
                    savedAssignment = _a.sent();
                    return [4 /*yield*/, instructor_1.assignmentRepository.findOne(savedAssignment)];
                case 3:
                    mintedAssignment = _a.sent();
                    return [2 /*return*/, mintedAssignment];
            }
        });
    });
}
exports.validateNewInstructor = validateNewInstructor;
//# sourceMappingURL=validateNewInstructor.js.map
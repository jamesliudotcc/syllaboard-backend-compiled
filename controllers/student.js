...
router.get('/deliverables', requireAuth, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                error_1 = _a.sent();
                console.log('Error with the user/deliverables/ GET route', error_1);
...
router.put('/deliverables/:id', requireAuth, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    var deliverable, editedDeliverable, updatedDeliverable, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (req.user.role !== 'student') {
            ...
            case 4:
                error_2 = _a.sent();
                console.log('Error with user/deliverable/ PUT route:', error_2);
